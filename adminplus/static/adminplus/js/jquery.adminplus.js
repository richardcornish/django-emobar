...
ADMIN_PLUS = (function ($) {
    ...
    miu_settings = {
        ...
        markupSet: [
            { name: 'Heading 1', key: '1', openWith: '# ', placeHolder: 'You should probably not use an H1 unless you know what you\'re doing...' },
            ...
            { name: 'Unordered list', openWith: '- '},
            { name: 'Ordered list', openWith: function (markItUp) { return markItUp.line + '. '; }},
            { separator: '---------------' },
            { name: 'Blockquote', openWith: '> '},
            { name: 'Code block', openWith: '(!(    |!|`)!)', closeWith: '(!(`)!)'},
            { separator: '---------------' },
            { name: 'Link', key: 'L', openWith: '[', closeWith: ']([![URL:!:http://]!] "[![Title]!]")', placeHolder: 'Your text to link here...' },
            { name: 'Bold', key: 'B', openWith: '**', closeWith: '**'},
            { name: 'Italic', key: 'I', openWith: '*', closeWith: '*'},
            { name: 'Deleted', key: 'D', openWith: '<del>', closeWith: '</del>'},
            { name: 'Code', key: 'K', openWith: '`', closeWith: '`'},
            { separator: '---------------' },
            { name: 'Horizontal rule', key: 'H', openWith: '\n* * *\n\n'},
            { separator: '---------------' },
            { name: 'People', dropMenu: [
                ...
                { name: 'Valentine', openWith: ' :valentine: '},
            ...
            { name: 'Nature', dropMenu: [
                ...
                { name: 'Honeybee', openWith: ' :honeybee: '},
                ...
                { name: 'Paw Prints', openWith: ' :paw_prints: '},
            ...
            { name: 'Objects', dropMenu: [
                ...
                { name: 'Sound Loud', openWith: ' :sound_loud: '},
                { name: 'Sound', openWith: ' :sound: '},
                { name: 'Speaker', openWith: ' :speaker: '},
                ...
                { name: 'Box', openWith: ' :box: '},
                { name: 'Pencil', openWith: ' :pencil: '},
                { name: 'Memo', openWith: ' :memo: '},
            ...
            { name: 'Places', dropMenu: [
                ...
                { name: 'City at Night', openWith: ' :city_at_night: '},
                ...
                { name: 'Bullettrain Side2', openWith: ' :bullettrain_side2: '},
                { name: 'Bullettrain Side', openWith: ' :bullettrain_side: '},
                { name: 'Light Rail', openWith: ' :light_rail: '},
                { name: 'Train Front', openWith: ' :train_front: '},
                { name: 'Monorail', openWith: ' :monorail: '},
                { name: 'Train', openWith: ' :train: '},
                { name: 'Trolley', openWith: ' :trolley: '},
            ...
            { name: 'Symbols', dropMenu: [
                ...
                { name: 'Arrowing Heading up', openWith: ' :arrowing_heading_up: '},
                { name: 'Ok', openWith: ' :ok: '},
                ...
                { name: 'Non-Potable Water', openWith: ' :non_potable_water: '},
                ...
                { name: 'Four Spoked Asterisk', openWith: ' :four_spoked_asterisk: '},
                ...
                { name: 'Curly Loops', openWith: ' :curly_loops: '},
                ...
                { name: 'Heavy Exclamation Mark', openWith: ' :heavy_exclamation_mark: '},
                { name: 'Heavy Question Mark', openWith: ' :heavy_question_mark: '},
                { name: 'Gray Exclamation Mark', openWith: ' :gray_exclamation_mark: '},
                { name: 'Gray Question Mark', openWith: ' :gray_question_mark: '},
                { name: 'O', openWith: ' :o: '},
                ...
                { name: 'Spade', openWith: ' :spade: '},
                { name: 'Hearts', openWith: ' :hearts: '},
                { name: 'Club', openWith: ' :club: '},
                { name: 'Diamond', openWith: ' :diamond: '},
                ...
                { name: 'Black Square With Border', openWith: ' :black_square_with_border: '},
                { name: 'White Square With Border', openWith: ' :white_square_with_border: '},
                { name: 'Black Square Small', openWith: ' :black_square_small: '},
                { name: 'White Square Small', openWith: ' :white_square_small: '},
                { name: 'Black Square Smaller', openWith: ' :black_square_smaller: '},
                { name: 'White Square Smaller', openWith: ' :white_square_smaller: '},
                ...
                { name: 'White Square', openWith: ' :white_square: '},
                { name: 'Black Square', openWith: ' :black_square: '},
